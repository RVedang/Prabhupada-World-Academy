...
type acknowledgeBvApprovalNotice_Input = Parameters<typeof acknowledgeBvApprovalNotice_Type.execute>[0]['input'];
...
const createSdkInvoker = (endpointName: string): any => {
  const fn: any = (input: any) => invokeEndpoint(endpointName, input);
  fn.execute = (opts: any) => invokeEndpoint(endpointName, opts?.input !== undefined ? opts.input : opts);
  return fn;
};
...
export const tagUserAsBvFacilitator = createSdkInvoker('tagUserAsBvFacilitator');
export const tagUserAsBvSubFacilitator = createSdkInvoker('tagUserAsBvSubFacilitator');
export const tagUserAsBvSupervisor = createSdkInvoker('tagUserAsBvSupervisor');
export const acknowledgeBvRoleNotice = createSdkInvoker('acknowledgeBvRoleNotice');
export const acknowledgeAshrayNotice = createSdkInvoker('acknowledgeAshrayNotice');
export const createMeeting = createSdkInvoker('createMeeting');
export const getMeetings = createSdkInvoker('getMeetings');
export const updateMeeting = createSdkInvoker('updateMeeting');
export const saveMom = createSdkInvoker('saveMom');
export const getMoms = createSdkInvoker('getMoms');
...
export const getBulkUserImportTemplate = createSdkInvoker('getBulkUserImportTemplate');
export const previewBulkUserImport = createSdkInvoker('previewBulkUserImport');
export const importBulkUsers = createSdkInvoker('importBulkUsers');
export const getBulkUserExportOptions = createSdkInvoker('getBulkUserExportOptions');
export const exportBulkUsers = createSdkInvoker('exportBulkUsers');
