  ...
  execute: async ({ context }: any) => {
    ...
    if (context.user.email && isMockAuthEnabled) {
      ...
      const defaults: Record<string, any> = {
        ...
        'vdnd@hkmmumbai.org': { userId: 'GUIDE-VEDANARAYANA-GUIDE', fullName: 'Vedanarayana Das', email: 'vdnd@hkmmumbai.org', role: 'Super Admin', isBvSuperAdmin: true, isBvAdmin: false, status: 'Active', segment: 'PW' },
