    ...
    <Card>
      ...
      <CardContent className="space-y-3">
        ...
        {status === 'not-setup' && (
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Enable push notifications to receive Sadhana reminders and admin notifications.
            </p>
        ...
        {status === 'enabled' && (
          <div className="space-y-3">
            <p className="text-sm text-muted-foreground">
              Push notifications are active for this device. You will receive Sadhana reminders and admin notifications.
            </p>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      You won't receive reminders or admin notifications on this device anymore. You can re-enable anytime.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
